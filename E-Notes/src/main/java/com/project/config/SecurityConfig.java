...
public class SecurityConfig {
	...
	//Here we are using BCryptPasswordEncoder for storing the password in encoded(encrypted) format in our database.
	//Means no one can easily leak that password from database
	@Bean
